...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServiceProviderClusterEtcdEncryptionSpec) DeepCopyInto(out *ServiceProviderClusterEtcdEncryptionSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServiceProviderClusterEtcdEncryptionSpec.
func (in *ServiceProviderClusterEtcdEncryptionSpec) DeepCopy() *ServiceProviderClusterEtcdEncryptionSpec {
	if in == nil {
		return nil
	}
	out := new(ServiceProviderClusterEtcdEncryptionSpec)
	in.DeepCopyInto(out)
	return out
}
