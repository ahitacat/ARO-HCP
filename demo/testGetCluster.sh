...
main() {
  ...
  (arm_system_data_header; correlation_headers; arm_x_ms_identity_url_header) | curl -si -X GET "localhost:8443/subscriptions/${SUBSCRIPTION_ID}/resourceGroups/${CUSTOMER_RG_NAME}/providers/Microsoft.RedHatOpenshift/hcpOpenShiftClusters/${CLUSTER_NAME}?api-version=2024-06-10-preview" \
    --header @-
}
